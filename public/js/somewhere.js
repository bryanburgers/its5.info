...
},{"./shuffle":8,"./zones":9,"moment-timezone":3}],3:[function(require,module,exports){
...
},{"random-js":7}],9:[function(require,module,exports){
module.exports = {
	...
	// -03:00
	"America/Argentina/Catamarca": false, // dup: America/Argentina/Mendoza
	"America/Argentina/Jujuy": false, // dup: America/Argentina/Mendoza
	"America/Argentina/La_Rioja": false, // dup: America/Argentina/Mendoza
	"America/Argentina/Mendoza": {
		"location": "Mendoza, Argentina"
		},
	"America/Argentina/Rio_Gallegos": false, // dup: America/Argentina/Mendoza
	"America/Argentina/Salta": false, // dup: America/Argentina/Mendoza
	"America/Argentina/San_Juan": false, // dup: America/Argentina/Mendoza
	"America/Argentina/Ushuaia": false,// dup: America/Argentina/Mendoza
	"America/Bahia": {
	...
	// -03:00 / -02:00
	"America/Araguaina": false, // dup: America/Sao_Paulo
	"America/Argentina/Buenos_Aires": {
		"location": "Buenos Aires, Argentina"
		},
	"America/Argentina/Cordoba": false, // dup: America/Argentina/Buenos_Aires
	"America/Argentina/Tucuman": false, // dup: America/Argentina/Buenos_Aires
	"America/Godthab": {
	...
	"America/Blanc-Sablon": {
		"location": "Blanc-Sablon, QC, Canada"
		},
	"America/Boa_Vista": {
	...
	"America/St_Thomas": {
		"location": "Saint Thomas, US Virgin Islands"
		},
	"America/St_Vincent": {
	...
	"America/Campo_Grande": {
		// Possibly a dup of America/Cuiaba?
		"location": "Campo Grande, Mato Grosso do Sul, Brazil"
		},
	"America/Cuiaba": {
		// Possibly a dup of America/Campo_Grande?
		"location": "Cuiabá, Mato Grosso, Brazil"
		},
	"America/Glace_Bay": false, // dup: America/Halifax
	"America/Goose_Bay": false, // dup: America/Halifax
	"America/Halifax": {
		"location": "Halifax, NS, Canada"
		},
	"America/Moncton": false, // dup: America/Halifax
	"America/Santiago": {
	...
	"America/Detroit": false, // dup: America/New_York
	"America/Grand_Turk": {
	...
	"America/Indiana/Indianapolis": false, // dup: America/New_York
	"America/Indiana/Marengo": false, // dup: America/New_York
	"America/Indiana/Petersburg": false, // dup: America/New_York
	"America/Indiana/Vevay": false, // dup: America/New_York
	"America/Indiana/Vincennes": false, // dup: America/New_York
	"America/Indiana/Winamac": false, // dup: America/New_York
	"America/Iqaluit": false, // dup: America/Toronto
	"America/Kentucky/Louisville": false, // dup: America/New_York
	"America/Kentucky/Monticello": false, // dup: America/New_York
	"America/Lima": {
		"location": "Lima, Peru"
		},
	"America/Montreal": false, // dup: America/Toronto
	"America/Nassau": {
	...
	"America/Nipigon": false, // dup: America/Toronto
	"America/Pangnirtung": false, // dup: America/Toronto
	"America/Port-au-Prince": {
		"location": "Port-au-Prince, Haiti"
		},
	"America/Thunder_Bay": false, // dup: America/Toronto
	"America/Toronto": {
	...
	// -06:00 / -05:00
	"America/Bahia_Banderas": false, // dup: America/Mexico_City
	"America/Belize": {
		"location": "Belize City, Belize"
		},
	"America/Cancun": false, // dup: America/Mexico_City
	"America/Chicago": {
	...
	"America/Indiana/Knox": false, // dup: America/Chicago
	"America/Indiana/Tell_City": false, // dup: America/Chicago
	"America/Managua": {
		"location": "Managua, Nicaragua"
		},
	"America/Matamoros": false, // dup: America/Chicago
	"America/Menominee": false, // dup: America/Chicago
	"America/Merida": false, // dup: America/Mexico_City
	"America/Mexico_City": {
	...
	"America/Rainy_River": false, // dup: America/Winnipeg
	"America/Rankin_Inlet": false, // dup: America/Winnipeg
	"America/Resolute": false, // dup: America/Winnipeg
	"America/Tegucigalpa": {
	...
	// -07:00
	"America/Creston": false, // dup: America/Dawson_Creek
	"America/Dawson_Creek": {
		// Not technically a duplicate of any place in Canada, but maybe we
		// should drop it because it will be covered by at least one major
		// city in Canada at any given time.
	...
	// -07:00 / -06:00
	"America/Boise": false, // dup: America/Denver
	"America/Cambridge_Bay": false, // dup: America/Edmonton
	"America/Chihuahua": {
	...
	"America/Inuvik": false, // dup: America/Edmonton
	"America/Mazatlan": false, // dup: America/Chihuahua
	"America/Ojinaga": {
		"location": "Juárez, Mexico"
		},
	"America/Yellowknife": false, // dup: America/Edmonton
	...
	// -08:00 / -07:00
	"America/Dawson": false, // dup: America/Vancouver
	"America/Los_Angeles": {
	...
	"America/Tijuana": false, // dup: America/Los_Angeles
	"America/Vancouver": {
	...
	"America/Juneau": false, // dup: America/Anchorage
	"America/Nome": false, // dup: America/Anchorage
